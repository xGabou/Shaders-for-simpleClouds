    ...
    #include "/lib/util/sc_bridge.glsl"
        ...
        vec3 baseAmbientColor = mix(clearAmbientColor, rainAmbientColor, rainFactor);
            ...
            float ambientThicknessBoost = mix(1.0, 0.9, thicknessMask);
                ...
                vec3 lightColor =
                    baseLightColor
                    * mix(1.0, mix(0.45, 0.58, scLightAmbientSunLeak), scStormDark * scRegionShadowActive)
                    * lightThicknessBoost
                    * lightDim
                    * thickDimLight;
                ...
                vec3 ambientColor =
                    baseAmbientColor
                    * mix(1.0, mix(0.70, 0.78, scLightAmbientSunLeak), scStormDark * scRegionShadowActive)
