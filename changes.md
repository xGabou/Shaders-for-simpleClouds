...
- Added `/shaders/lib/util/simpleCloudsBridge.glsl` to centralize the `simpleCloudsCloudState` and `simpleCloudsCloudType` uniform handling plus helper functions (visibility, thickness, storm factors, type-based shading curves).
